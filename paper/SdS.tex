...
The medium-to-fine changes in Table~\ref{tab:localized} are at most
$10^{-4}\%$, more than a factor of $60$ below the smallest difference; they
...
in all four tested cases, so the fits test these powers but do not determine
