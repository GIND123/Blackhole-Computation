...
Recent work has advanced direct compactified hyperboloidal evolution of the
nonlinear Einstein equations in spherical symmetry in both generalized
harmonic and conformal BSSN/Z4 formulations
\cite{Peterson:2024spherical,VanoVinuales:2024reference}.  In the strongly
compactified generalized harmonic system, constraint additions, gauge
choices, and reduction fields have been used to minimize the number of
formally singular terms \cite{Peterson:2025strong}, and
fully coupled Einstein--Maxwell--Klein--Gordon evolutions extend the
conformal BSSN/Z4 program to charged matter and black-hole formation
\cite{Alvares:2025emkg}.  Three-dimensional test fields and asymptotic model
systems have also been evolved
\cite{Zenginoglu:2010zm,Peterson:2023bha}.  In these compactified
free-evolution programs, however, a robust three-dimensional scri-fixed
evolution of generic black-hole spacetimes with the full Einstein equations
remains open.  Artificial cosmology may offer a complementary route to that
goal by replacing evaluation at $\Omega=0$ with a finite cosmological horizon,
but only a nonlinear Einstein calculation can determine whether this helps in
practice.
...
uses the common simulated interval $0.000411\leq U/M\leq57.2274$, which runs
...
supplies the reference.  The processed conditioning data and
...
spherical harmonic.  In the sphere-integrated norm \eqref{eq:parseval_norm}, the direct
...
\begin{table}[t]
 ...
 the common simulated interval $0.000411\leq U/M\leq57.2274$.  The interval
...
a robust three-dimensional scri-fixed evolution of generic black-hole
spacetimes remains open.  Artificial cosmology may help to overcome that
obstacle; establishing whether it does requires the nonlinear Einstein code
that lies beyond the present scalar study.
...
windows in Sec.~\ref{sec:direct_recovery} are labeled diagnostic for the separate
numerical reason that their refinement change is not subdominant.

\section{Reproducibility record}
\label{app:reproducibility}

The frozen scalar-wave campaign separates simulation from analysis at the
...
single clean simulation commit \texttt{2460d976}.  Every production table
...
for the percent-level waveform comparisons.  The very small localized
